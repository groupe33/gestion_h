...
<html lang="en">
   ...
   <head>
      ...
      <script>
         window._wpemojiSettings = {"baseUrl":"https:\/\/s.w.org\/images\/core\/emoji\/14.0.0\/72x72\/","ext":".png')}}","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/14.0.0\/svg\/","svgExt":".svg","source":{"concatemoji":"https:\/\/garantiwebtasarim.com\/wordpress\/medidoc\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.4.1"}};
         ...
         <div class="inner">
            ...
            <div class="hide-mobile">
               ...
               <address class="address">
                  ...
                  <div class="bosluksv"></div>
                  <div class="or">
                     <a href="#"><i class="lni-facebook-filled iconsocia"></i></a>
                     <a href="#"><i class="lni-instagram-filled iconsociai"></i></a>
                     <a href="#"><i class="lni-twitter-filled iconsocia"></i></a>
                  </div>
               </address>
            </div>
                  ...
                  <div class="menu">
                     ...
                     <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
                        <ul id="menu-mobil-menu" class="nav navbar-nav" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                           <li  id="menu-item-1149" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5 current_page_item active menu-item-1149 nav-item"><a itemprop="url" href="index.html" class="nav-link" aria-current="page"><span itemprop="name">Home</span></a></li>
                           <li  id="menu-item-1150" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1150 nav-item"><a itemprop="url" href="about-us/index.html" class="nav-link"><span itemprop="name">About Us</span></a></li>
                           <li  id="menu-item-1151" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-1151 nav-item">
                              <a href="#" data-toggle="dropdown" aria-expanded="false" class="dropdown-toggle nav-link" id="menu-item-dropdown-1151"><span itemprop="name">Departments</span></a>
                              <ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-1151">
                                 <li  id="menu-item-1423" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1423 nav-item"><a itemprop="url" href="urology/index.html" class="dropdown-item"><span itemprop="name">Urology</span></a></li>
                                 ...
                                 <li  id="menu-item-1158" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1158 nav-item"><a itemprop="url" href="all-departments/index.html" class="dropdown-item"><span itemprop="name">All Departments</span></a></li>
                              </ul>
                           </li>
                           <li  id="menu-item-1424" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1424 nav-item"><a itemprop="url" href="doctors/index.html" class="nav-link"><span itemprop="name">Doctors</span></a></li>
                           <li  id="menu-item-1161" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1161 nav-item"><a itemprop="url" href="blog/index.html" class="nav-link"><span itemprop="name">Blog</span></a></li>
                           <li  id="menu-item-1162" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1162 nav-item"><a itemprop="url" href="contact/index.html" class="nav-link"><span itemprop="name">Contact</span></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
      ...
      <nav class="navbar navbar-expand-md navbar-light bg-light">
         ...
         <div class="container">
               ...
               <div class="menueffect">
                  <div id="bs-example-navbar-collapse-2" class="collapse navbar-collapse">
                     <ul id="menu-main-menu" class="nav navbar-nav" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                        <li  id="menu-item-322" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5 current_page_item active menu-item-322 nav-item"><a itemprop="url" href="index.html" class="nav-link" aria-current="page"><span itemprop="name">Accueil</span></a></li>
                        <li  id="menu-item-329" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-329 nav-item"><a itemprop="url" href="about-us/index.html" class="nav-link"><span itemprop="name">A Propos</span></a></li>
                        <li  id="menu-item-980" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-980 nav-item">
                           <a href="#" data-toggle="dropdown" aria-expanded="false" class="dropdown-toggle nav-link" id="menu-item-dropdown-980"><span itemprop="name">Departements</span></a>
                           <ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-980">
                              <li  id="menu-item-1432" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1432 nav-item"><a itemprop="url" href="urology/index.html" class="dropdown-item"><span itemprop="name">Urology</span></a></li>
                              ...
                              <li  id="menu-item-364" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-364 nav-item"><a itemprop="url" href="all-departments/index.html" class="dropdown-item"><span itemprop="name">All Departments</span></a></li>
                           </ul>
                        </li>
                        <li  id="menu-item-1433" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1433 nav-item"><a itemprop="url" href="doctors/index.html" class="nav-link"><span itemprop="name">Medecins</span></a></li>
                        <li  id="menu-item-354" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-354 nav-item"><a itemprop="url" href="blog/index.html" class="nav-link"><span itemprop="name">Blog</span></a></li>
                        <li  id="menu-item-353" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-353 nav-item"><a itemprop="url" href="contact/index.html" class="nav-link"><span itemprop="name">Contact</span></a></li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="navbar-button">
               <div class="telh" onclick="location.href='appointment/index.html';" style="cursor:pointer;"><i class="flaticon-timetable iconp"></i>&nbsp;&nbsp;&nbsp;Appointment</div>
            </div>
         </div>
      </nav>
