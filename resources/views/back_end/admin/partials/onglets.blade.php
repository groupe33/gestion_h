    ...
    <div class="nav-content d-flex">
       ...
       <div class="user-container d-flex">
          <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             <img class="profile" alt="profile" src="{{asset('img/profile/profile-1.webp')}}">
       ...
       <div class="menu-container flex-grow-1">
          <ul id="menu" class="menu">
             <li>
                ...
                <span class="label">Tableau de board</span>
                </a>
                <ul id="dashboards">
                   <li>
                      <a href="Dashboards.Patient.html">
            ...
            <li>
             <a href="#dashboards1" data-href="Dashboards.Patient.html">
               <i data-acorn-icon="home-garage" class="icon" data-acorn-size="18"></i>
               ...
               <ul id="dashboards1">
                  <li>
                     <a href="Dashboards.Patient.html">
                     <span class="label">Tous rendez_vous</span>
                     </a>
                  </li>
                  <li>
                     <a href="Dashboards.Doctor.html">
                     <span class="label">Prendre un rendez_vous</span>
                     </a>
                  </li>
               </ul>
            </li>
            -<li>
               <a href="#dashboards2" data-href="Dashboards.Patient.html">
                 <i data-acorn-icon="home-garage" class="icon" data-acorn-size="18"></i>
                 ...
                 <ul id="dashboards2">
                    <li>
                       <a href="Dashboards.Patient.html">
                       <span class="label">Boite de reception</span>
                       </a>
                    </li>
                    <li>
                       <a href="Dashboards.Doctor.html">
                       <span class="label">Envoyer email</span>
                       </a>
                    </li>
                 </ul>
              </li>
       ...
       <div class="mobile-buttons-container">
          <a href="#" id="mobileMenuButton1" class="menu-button">
