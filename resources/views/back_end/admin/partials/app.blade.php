...
<html lang="en" data-footer="true">
   <!-- Mirrored from acorn-html-medical-assistant.coloredstrategies.com/Dashboards.Doctor.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Dec 2023 01:11:23 GMT -->
   <head>
      <meta charset="UTF-8">
      ...
      <link rel="stylesheet" href="{{asset('lien_dasboard/font/CS-Interface/style.css')}}">
      <link rel="stylesheet" href="{{asset('lien_dasboard/css/vendor/bootstrap.min.css')}}">
      <link rel="stylesheet" href="{{asset('lien_dasboard/css/vendor/OverlayScrollbars.min.css')}}">
      <link rel="stylesheet" href="{{asset('lien_dasboard/css/vendor/fullcalendar.min.css')}}">
      <link rel="stylesheet" href="{{asset('lien_dasboard/css/styles.css')}}">
      <link rel="stylesheet" href="{{asset('lien_dasboard/css/main.css')}}">
      <script src="{{asset('lien_dasboard/js/base/loader.js')}}"></script>

      {{-- second lien pour les entete --}}
   ...
   <body>
      <div id="root">
        ...
        {{-- onglets debut --}}
            @include('back_end.Administrateur.partials.onglets')
        {{-- onglets fin  --}}
         <main>
            <div class="container">
                {{-- titre du contenu debut --}}
                    @include('back_end.Administrateur.partials.titre')
                 {{-- titre du contenu fin  --}}

                 {{-- contenu du tableau de board debut --}}

                    @yield('contenu_dasboard')

                    {{-- contenu du tableau de board fin  --}}
            </div>
         </main>
         <footer>
      ...
      <script src="{{asset('lien_dasboard/js/vendor/jquery-3.5.1.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/bootstrap.bundle.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/OverlayScrollbars.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/autoComplete.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/clamp.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/icon/acorn-icons.js')}}"></script>
      <script src="{{asset('lien_dasboard/icon/acorn-icons-interface.js')}}"></script>
      <script src="{{asset('lien_dasboard/icon/acorn-icons-medical.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/Chart.bundle.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/chart-plugin-rounded-bar.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/chart-plugin-crosshair.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/vendor/fullcalendar/main.min.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/base/helpers.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/base/globals.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/base/nav.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/base/search.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/base/settings.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/cs/charts.extend.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/pages/dashboards.doctor.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/common.js')}}"></script>
      <script src="{{asset('lien_dasboard/js/scripts.js')}}"></script>
   </body>
   <!-- Mirrored from acorn-html-medical-assistant.coloredstrategies.com/Dashboards.Doctor.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Dec 2023 01:11:27 GMT -->
</html>
