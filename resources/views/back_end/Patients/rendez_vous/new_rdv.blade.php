@extends('back_end.Medecins.partials.app')
...
<main>
    ...
    <h1 class="mb-0 pb-0 display-4" id="title">Rendez-vous en ligne</h1>
    </div>
    </div>
    </div>
    <h2 class="small-title">Rendez-vous a</h2>
    ...
    <div class="mb-1 title d-none d-sm-block">Services</div>
    <div class="text-small description d-none d-md-block">choisi un service</div>
    </a>
    </li>
    <li class="nav-item" role="presentation">
    <a class="nav-link text-center" href="#doctorTab" role="tab">
    <div class="mb-1 title d-none d-sm-block">Médecin</div>
    <div class="text-small description d-none d-md-block">Choisi un médecin</div>
    </a>
    </li>
    <li class="nav-item" role="presentation">
    <a class="nav-link text-center" href="#dateTab" role="tab">
    <div class="mb-1 title d-none d-sm-block">Date</div>
    <div class="text-small description d-none d-md-block">Choisi une date et heure</div>
    </a>
    </li>
