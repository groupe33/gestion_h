...
<div class="page-title-container">
   <div class="row">
      <div class="col-12 col-md-7">
         ...
         <h1 class="mb-0 pb-0 display-4" id="title">Paramètres</h1>
      </div>
   </div>
</div>
<div class="row gx-5">
   <div class="col-xl-8">
      ...
      <h2 class="small-title">Information Personnel</h2>
      <div class="card mb-5">
         <div class="card-body">
            <form>
               <div class="mb-3 row">
                  <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Nom</label>
                  <div class="col-sm-8 col-md-9 col-lg-10">
                     <input type="text" class="form-control" value="Lisa Jackson">
                  </div>
               </div>
               <div class="mb-3 row">
                  <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Nom Utilisateur</label>
                  <div class="col-sm-8 col-md-9 col-lg-10">
               ...
               <div class="mb-3 row">
                  ...
                  <div class="col-sm-8 col-md-9 col-lg-10">
                     <input type="email" class="form-control" value="me@lisajackson.com" disabled="disabled">
                  </div>
               </div>
