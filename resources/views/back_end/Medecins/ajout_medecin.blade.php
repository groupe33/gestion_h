...
<div class="row">
 ...
 <div class="col-md-9">
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{route('back_end.medecins.store')}}" enctype="multipart/form-data" method="post">
         @csrf
        ...
        <div id="step1" class="step">
          <div class="row">
            ...
            <div class="form-group col-sm-6 mb-2">
                ...
                @error('service_id')<span class="badge badge-danger bg-danger">{{ $message }}</span>@enderror
            </div>

            <div class="form-group col-sm-6 mb-2">
                <label for="">Specialite</label>
                <input type="text" name="specialite" value="{{old('specialite')}}"  class="form-control ">
                 @error('specialite')<span class="badge badge-danger bg-danger">{{$message}}</span>@enderror
            </div>
