@extends('back_end.Medecins.partials.appmessage')

@section('contenu_chat')


<   <!-- PAGE-HEADER -->
<div class="page-header d-flex align-items-center justify-content-between border-bottom mb-4">

    <h1 class="page-title"> <a class="dropdown-item" href=""><i class="fe fe-user me-1 d-inline-flex"></i> Home</a></h1>
    <div>
        <ol class="breadcrumb">
                        ...
                        <div class="">
                            ...
                            <div class="">
                                ...
                                <ul id="lightgallery" class="list-unstyled row">
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mt-2 border-bottom-0 px-1" data-responsive="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/01.jpg')}}" data-src="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/01.jpg')}}" data-sub-html="<h4>Gallery Image 1</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0);">
                                            <img class="img-responsive br-5" src="{{asset('build/assets/images/media/files/01.jpg')}}" alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mt-2 border-bottom-0 px-1" data-responsive="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/02.jpg')}}" data-src="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/02.jpg')}}" data-sub-html="<h4>Gallery Image 2</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0);">
                                            <img class="img-responsive br-5" src="{{asset('build/assets/images/media/files/02.jpg')}}" alt="Thumb-2">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mt-2 border-bottom-0 px-1" data-responsive="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/03.jpg')}}" data-src="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/03.jpg')}}" data-sub-html="<h4>Gallery Image 3</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0);">
                                            <img class="img-responsive br-5" src="{{asset('build/assets/images/media/files/03.jpg')}}" alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mt-2 border-bottom-0 px-1" data-responsive="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/04.jpg')}}" data-src="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/04.jpg')}}" data-sub-html=" <h4>Gallery Image 4</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0);">
                                            <img class="img-responsive br-5" src="{{asset('build/assets/images/media/files/04.jpg')}}" alt="Thumb-2">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mt-2 border-bottom-0 px-1" data-responsive="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/05.jpg')}}" data-src="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/05.jpg')}}" data-sub-html="<h4>Gallery Image 5</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0);">
                                            <img class="img-responsive br-5" src="{{asset('build/assets/images/media/files/05.jpg')}}" alt="Thumb-1">
                                        </a>
                                    </li>
                                    <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mt-2 border-bottom-0 px-1" data-responsive="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/06.jpg')}}" data-src="https://laravelui.spruko.com/vexel/{{asset('build/assets/images/media/files/06.jpg')}}" data-sub-html="<h4>Gallery Image 6</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                        <a href="javascript:void(0);">
